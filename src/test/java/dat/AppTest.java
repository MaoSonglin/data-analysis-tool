...
public class AppTest 
{
	...
	public void testGetOracleConntion() throws Exception{
		...
		try(Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@192.168.62.198:1521:ORCL", "DBL", "Huawei12#$")){
			...
			ResultSet rs = st.executeQuery("select count(1) count from tb_info_reg");
			while(rs.next()){
