...
public class Classify {
	public static void main(String[] args) {
		Classify classify = new Classify("中文系那个大声道非","hxgsdf32","VARCHAR");
	...
	private static Logger logger = LogManager.getLogger(Classify.class);
	...
	static{
		try(InputStream is = Classify.class.getResourceAsStream("cluster.json");
		...
		URL res = Classify.class.getResource("df_info_reg.csv");
	...
	public Classify(String cnName,String enName,String dataType) {
		this.cnName = cnName;
		this.enName = enName;
